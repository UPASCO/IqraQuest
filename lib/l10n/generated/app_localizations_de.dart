...
class AppLocalizationsDe extends AppLocalizations {
  ...
  @override
  String get purchaseInProgress => 'Kauf läuft…';
  ...
  String get levelMixedHint =>
      'Gemischt: jede Karte zieht ihre Stufe, von den ersten Schritten bis Experte.';
  ...
  @override
  String get computerStrengthLabel => 'Stärke der Gegner';

  @override
  String get strengthLabelShort => 'Stärke';

  @override
  String get autoRidersNote => 'Automatische Reiter';
  ...
  String get questionLevelNote =>
      'Fragenstufe: im nächsten Schritt, pro Spieler.';
  ...
  @override
  String get courseCalm => 'Ruhig';

  @override
  String get courseLively => 'Lebhaft';

  @override
  String get courseIntense => 'Intensiv';

  @override
  String get courseSquareOasis => 'Oase: dein Pferd ist dort sicher';

  @override
  String get courseSquareKnowledge => 'Wissen: +1 Wissenspunkt';

  @override
  String get courseSquareChallenge =>
      'Herausforderung: eine Extrafrage für +2 Felder';

  @override
  String get courseSquareShortcut =>
      'Abkürzung: eine schwere Frage, um vorzuspringen';

  @override
  String get courseSquareWisdom =>
      'Weisheit: ein Fakt zum Entdecken und Behalten';

  @override
  String get levelEasyHint =>
      'Leicht: einfache Fragen zu dem, was man zuerst lernt.';

  @override
  String get levelIntermediateHint =>
      'Mittel: für alle, die Geschichten und Regeln schon gut kennen.';
  ...
  @override
  String get schoolMode => 'Schulmodus';

  @override
  String get teacherConsole => 'Lehrerkonsole';
  ...
  @override
  String get teacherSendLink => 'Link zusenden';

  @override
  String teacherLinkSent(String email) {
    return 'Link an $email gesendet. Öffne ihn auf diesem Gerät.';
  }
  ...
  String get teacherLicencePaidElsewhere =>
      'Die Zahlung läuft über die sichere Stripe-Seite; komm danach hierher zurück.';

  @override
  String get teacherRefresh => 'Erneut prüfen';

  @override
  String get teacherSignOut => 'Abmelden';

  @override
  String teacherLicenceUntil(String date) {
    return 'Lizenz gültig bis $date';
  }

  @override
  String get teacherLicenceExpired => 'Lizenz abgelaufen';

  @override
  String get levelLabel => 'Stufe';

  @override
  String get teacherChooseLesson => 'Lektion wählen';

  @override
  String get teacherScoringMode => 'Wie gezählt wird';

  @override
  String get teacherScoringTeams => 'Nach Teams';

  @override
  String get teacherScoringIndividual => 'Einzelwertung';

  @override
  String get teacherScoringIndividualHint =>
      'Jeder Vorname erscheint in der Rangliste an der Tafel. Eine Rangliste zeigt den Ersten — und auch den Letzten, vor der ganzen Klasse.';

  @override
  String get teacherTimer => 'Zeitnehmer';

  @override
  String get teacherTimerNone => 'Keiner — ich decke selbst auf';
  ...
  @override
  String get teacherLength => 'Länge';

  @override
  String teacherLengthAll(num count) {
    return 'Ganze Lektion ($count Karten)';
  }

  @override
  String teacherLengthShort(num count) {
    return 'Die ersten $count Karten';
  }

  @override
  String get teacherShuffle => 'Kartenreihenfolge mischen';

  @override
  String get teacherShuffleHint =>
      'Eine Klasse, die dieselbe Lektion wiederholt, antwortet nicht mehr auswendig.';

  @override
  String get classroomScanToJoin => 'Scannen — oder Code eingeben';

  @override
  String get classroomRanking => 'Rangliste';
  ...
  @override
  String get teacherCreateAccount => 'Konto erstellen';

  @override
  String get teacherHaveAccount => 'Ich habe schon ein Konto';

  @override
  String get teacherSignUpHint =>
      'Kostenlos, ohne Karte. Dein Konto bekommt fünf Spiele, um den Schulmodus auszuprobieren.';

  @override
  String get teacherSignUpButton => 'Mein Konto erstellen';

  @override
  String get teacherAwaitingConfirmationTitle => 'Bestätige deine Adresse';

  @override
  String teacherAwaitingConfirmationBody(String email) {
    return 'Eine E-Mail ist unterwegs an $email. Öffne den Link darin und melde dich dann an.';
  }

  @override
  String get teacherEmailTaken =>
      'Diese Adresse hat schon ein Konto. Melde dich an oder nutze „Passwort vergessen?“.';

  @override
  String get teacherWeakPassword =>
      'Das Passwort muss mindestens sechs Zeichen haben.';

  @override
  String get teacherOfferDiscovery => 'Kennenlern-Angebot';
  ...
  String teacherFreeGamesLeft(num left, num total) {
    String _temp0 = intl.Intl.pluralLogic(
      left,
      locale: localeName,
      other: '$left / $total Gratisspiele übrig',
      one: '$left / $total Gratisspiel übrig',
    );
    return '$_temp0';
  }

  @override
  String get teacherQuotaTitle => 'Deine Gratisspiele sind aufgebraucht';

  @override
  String get teacherQuotaBody =>
      'Du hast deine fünf Gratisspiele genutzt. Wechsle zu IqraQuest École und erstelle ein Jahr lang unbegrenzt Spiele.';

  @override
  String get teacherSubscribe => 'IqraQuest École abonnieren';

  @override
  String get teacherSubscribeOnSite =>
      'Das Abonnement wird über den Bereich deiner Schule verwaltet, am Computer.';

  @override
  String teacherDevicesActive(num used, num total) {
    return 'Aktive Geräte: $used / $total';
  }

  @override
  String get teacherPitchTitle => 'Lassen Sie Ihre Klasse spielen';

  @override
  String get teacherPitchBody =>
      'Sie wählen eine Lektion. An der Tafel erscheint ein Code. Ihre Schüler tippen ihn auf Handy oder Tablet ein und beantworten die Fragen – alle gleichzeitig.';

  @override
  String get teacherPitchPointFree =>
      'Konto anlegen: 5 Gratisspiele zum Ausprobieren';

  @override
  String get teacherPitchPointPlan =>
      'Danach IqraQuest École: unbegrenzt spielen, das ganze Jahr';

  @override
  String get teacherPitchPointPupils =>
      'Ihre Schüler machen mit dem Code mit, ganz ohne Konto';
  ...
  String get teacherNoAccount =>
      'Für diese Adresse gibt es kein Konto. Lege eines an – kostenlos.';

  @override
  String get teacherEmailNotConfirmed =>
      'Deine Adresse ist noch nicht bestätigt. Öffne den Link aus der E-Mail oder fordere einen neuen an.';

  @override
  String get teacherResendEmail => 'E-Mail erneut senden';

  @override
  String get teacherSchoolNameLabel => 'Name der Schule (optional)';

  @override
  String get teacherSubscriptionActiveDelete =>
      'Dein Abonnement läuft noch. Kündige es zuerst unter „Mein Abonnement verwalten“ und lösche dann das Konto.';

  @override
  String get teacherSetNewPasswordHint =>
      'Du bist über einen Link hereingekommen. Wähle jetzt ein neues Passwort.';

  @override
  String get teacherManageDevices => 'Meine Geräte verwalten';

  @override
  String get teacherDeviceLimitTitle => 'Gerätelimit erreicht';

  @override
  String teacherDeviceLimitBody(num count) {
    return 'Deine Lizenz erlaubt $count gleichzeitige Spielsitzungen. Schließe eine Sitzung auf einem anderen Gerät oder trenne es unten.';
  }

  @override
  String get teacherDisconnectDevice => 'Trennen';

  @override
  String get teacherNoActiveDevices => 'Gerade spielt kein Gerät.';
  ...
  @override
  String get teacherDeviceStale => 'Antwortet nicht — Platz frei';

  @override
  String get teacherManageSubscription => 'Mein Abonnement verwalten';

  @override
  String get teacherSubscriptionActive =>
      'Deine IqraQuest-École-Lizenz ist aktiv.';

  @override
  String teacherCancelAtPeriodEnd(String date) {
    return 'Verlängerung gekündigt. Deine Lizenz bleibt bis $date aktiv.';
  }

  @override
  String get teacherPaymentFailedTitle => 'Zahlungsproblem';

  @override
  String get teacherPaymentFailedBody =>
      'Dein Abonnement braucht eine aktualisierte Zahlungsmethode. Eine laufende Sitzung darf enden; die nächste wartet auf die Klärung.';

  @override
  String get teacherUpdatePayment => 'Zahlungsmethode aktualisieren';

  @override
  String get teacherChangePassword => 'Passwort ändern';

  @override
  String get teacherNewPassword => 'Neues Passwort';

  @override
  String get teacherPasswordChanged => 'Passwort geändert.';

  @override
  String get teacherDeleteAccount => 'Mein Konto löschen';

  @override
  String get teacherDeleteAccountHint =>
      'Profil, Lizenz, Sitzungen und ihre Berichte werden gelöscht. Rechnungen bleiben bei Stripe, das sie aufbewahren muss. Das lässt sich nicht rückgängig machen.';

  @override
  String get teacherConfirmDelete => 'Ja, endgültig löschen';

  @override
  String get teacherNetworkNeeded =>
      'Für ein neues Schulspiel ist eine Verbindung nötig.';

  @override
  String get teacherAccountSection => 'Mein Konto';

  @override
  String get teacherPasswordLabel => 'Passwort';

  @override
  String get teacherSignIn => 'Anmelden';

  @override
  String get teacherSignInPasswordHint =>
      'Gib die Adresse deiner Schule und dein Passwort ein.';

  @override
  String get teacherBadCredentials => 'Adresse oder Passwort falsch.';

  @override
  String get teacherForgotPassword => 'Passwort vergessen?';

  @override
  String get teacherAccount => 'Dein Abonnement';
  ...
  String teacherAccountRooms(num used, num total) {
    String _temp0 = intl.Intl.pluralLogic(
      used,
      locale: localeName,
      other: '$used von $total Räumen offen',
      one: '$used von $total Räumen offen',
    );
    return '$_temp0';
  }
  ...
  String get teacherRenewByEmail =>
      'Schreib uns zum Verlängern: wir öffnen deinen Bereich noch am selben Tag.';
  ...
  @override
  String get teacherAccountEndingSoon => 'Dein Abonnement endet bald.';

  @override
  String get teacherAccountRenews => 'Es verlängert sich automatisch.';

  @override
  String get teacherExpired => 'Dein Abonnement ist beendet';

  @override
  String get teacherExpiredHint =>
      'Es lässt sich keine Sitzung mehr öffnen. Dein Verlauf bleibt erhalten, und eine Verlängerung öffnet sofort wieder alles.';

  @override
  String get teacherRenew => 'Abonnement verlängern';

  @override
  String get teacherHistory => 'Vergangene Sitzungen';

  @override
  String get teacherHistoryOpen => 'Verlauf ansehen';

  @override
  String get teacherHistoryEmpty => 'Noch keine abgeschlossene Sitzung.';
  ...
  String get teacherHistoryNamesGone =>
      'Die Namen dieser Sitzung wurden gelöscht (90 Tage).';

  @override
  String get teacherMarksTitle => 'Noten zum Übertragen';

  @override
  String teacherMarksHint(num cards) {
    return 'Von 20, über die $cards Karten der Sitzung.';
  }
  ...
  @override
  String get teacherBoardLanguage => 'Sprache der Tafel';

  @override
  String get teacherOpenSession => 'Sitzung öffnen';

  @override
  String get teacherOpenBoard => 'Tafel öffnen';

  @override
  String get teacherNextQuestion => 'Nächste Frage';

  @override
  String get teacherRevealAnswer => 'Antwort zeigen';

  @override
  String get teacherEndSession => 'Sitzung beenden';

  @override
  String get teacherEndSessionHint =>
      'Die Sitzung wird geschlossen und die Namen der Schüler werden gelöscht. Die Auswertung je Frage bleibt.';

  @override
  String teacherTooManySessions(num limit) {
    return 'Diese Lizenz betreibt $limit Raum/Räume gleichzeitig.';
  }
  ...
  String get teacherTooManyLinks =>
      'Zu viele Links angefordert. Warte eine Stunde oder prüfe den E-Mail-Versand des Servers.';

  @override
  String get teacherUnreachable =>
      'Der Server antwortet nicht. Versuche es gleich noch einmal.';

  @override
  String get teacherSessionRunning => 'Sitzung läuft';
