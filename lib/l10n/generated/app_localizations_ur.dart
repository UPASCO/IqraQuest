...
class AppLocalizationsUr extends AppLocalizations {
  ...
  String get ruleExitBody =>
      'ہر کھلاڑی کے چار گھوڑے ہیں، اور پہلا پہلے ہی اپنے آغاز کے خانے پر کھڑا ہے: آپ پہلی ہی کارڈ سے کھیلتے ہیں، بغیر انتظار کے۔ باقی تین اصطبل سے 6 پر نکلتے ہیں: درست جواب دیں اور گھوڑا آغاز کے خانے پر آ جاتا ہے — اور چونکہ 6 دوبارہ کھلاتا ہے، وہ فوراً روانہ ہو جاتا ہے۔ فیصلہ آپ کا: ایک اور نکالیں یا آگے بڑھیں۔';
  ...
  String get ruleStreakBody =>
      'لگاتار تین درست جواب ایک ڈھال دیتے ہیں، پانچ گرینڈ گیلپ اور دس مہارت کا بیج۔ گرینڈ گیلپ خود خرچ ہوتا ہے، اور صرف تب جب اس کے +2 خانے اختتام تک پہنچنے کے لیے کافی ہوں۔ بونس صرف علم سے ملتے ہیں۔';
