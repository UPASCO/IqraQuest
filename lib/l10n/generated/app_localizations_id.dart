...
class AppLocalizationsId extends AppLocalizations {
  ...
  @override
  String get newGameTitle => 'Permainan baru';
  ...
  @override
  String get raceLengthShort => 'Permainan singkat';

  @override
  String get raceLengthMedium => 'Permainan sedang';
  ...
  @override
  String get saveGameHint => 'Beri nama agar mudah ditemukan nanti';
  ...
  @override
  String get noSavedGames => 'Belum ada permainan tersimpan.';

  @override
  String get noSavedGamesHint =>
      'Saat bermain, buka menu ≡ papan lalu pilih “Simpan Permainan”.';

  @override
  String get deleteSave => 'Hapus simpanan ini';

  @override
  String deleteSaveConfirm(String name) {
    return 'Hapus “$name”? Permainan tersimpan ini akan hilang.';
  }
  ...
  @override
  String get gameInProgressTitle => 'Ada permainan yang sedang berjalan';

  @override
  String get gameInProgressReplaceBody =>
      'Permainan itu akan diganti. Simpan dulu dengan sebuah nama?';
  ...
  String savesFull(num count) {
    return 'Kamu sudah punya $count permainan tersimpan: hapus satu atau pakai nama yang sudah ada.';
  }
  ...
  @override
  String get freeTourTitle => 'Kamu sudah melihat semua kartu gratis';

  @override
  String freeTourBody(int free, int total) {
    return '$free kartu gratis sekarang akan berulang. Premium membuka semua $total kartu, semua lintasan, dan simpanan, dalam satu pembelian.';
  }

  @override
  String freeTourCta(int total) {
    return 'Buka semua $total kartu';
  }
  ...
  String get teacherSignInHint =>
      'Masukkan alamat Anda: kami mengirim tautan untuk masuk dan memilih kata sandi baru.';
  ...
  @override
  String get teacherScoringMode => 'Cara poin dihitung';

  @override
  String get teacherScoringTeams => 'Per tim';

  @override
  String get teacherScoringIndividual => 'Peringkat individu';

  @override
  String get teacherScoringIndividualHint =>
      'Setiap nama tampil berperingkat di papan. Peringkat menampilkan yang pertama, tetapi juga yang terakhir, di depan seluruh kelas.';

  @override
  String get teacherTimer => 'Pengatur waktu';

  @override
  String get teacherTimerNone => 'Tidak ada — saya buka sendiri';
  ...
  String teacherLengthAll(num count) {
    return 'Seluruh pelajaran ($count kartu)';
  }

  @override
  String teacherLengthShort(num count) {
    return '$count kartu pertama';
  }

  @override
  String get teacherShuffle => 'Acak urutan kartu';

  @override
  String get teacherShuffleHint =>
      'Kelas yang mengulang pelajaran yang sama tidak lagi menjawab dari ingatan.';

  @override
  String get classroomScanToJoin => 'Pindai, atau masukkan kode';

  @override
  String get classroomRanking => 'Peringkat';
  ...
  String get teacherPitchBody =>
      'Anda memilih pelajaran. Sebuah kode muncul di papan. Murid mengetiknya di ponsel atau tablet dan menjawab pertanyaan, semuanya bersamaan.';

  @override
  String get teacherPitchPointFree =>
      'Buat akun Anda: 5 permainan gratis untuk mencoba';

  @override
  String get teacherPitchPointPlan =>
      'Lalu IqraQuest École: permainan tanpa batas sepanjang tahun';

  @override
  String get teacherPitchPointPupils =>
      'Murid bergabung dengan kode, tanpa membuat akun';
  ...
  String teacherAccountRooms(num used, num total) {
    String _temp0 = intl.Intl.pluralLogic(
      used,
      locale: localeName,
      other: '$used dari $total ruang terbuka',
    );
    return '$_temp0';
  }
  ...
  String get teacherRenewByEmail =>
      'Tulis kepada kami untuk memperpanjang: ruang Anda kami buka kembali hari itu juga.';
  ...
  @override
  String get teacherAccountEndingSoon => 'Langganan Anda segera berakhir.';

  @override
  String get teacherAccountRenews => 'Diperpanjang otomatis.';

  @override
  String get teacherExpired => 'Langganan Anda telah berakhir';

  @override
  String get teacherExpiredHint =>
      'Tidak ada sesi yang bisa dibuka lagi. Riwayat Anda tetap ada, dan perpanjangan membuka semuanya kembali seketika.';

  @override
  String get teacherRenew => 'Perpanjang langganan';

  @override
  String get teacherHistory => 'Sesi sebelumnya';

  @override
  String get teacherHistoryOpen => 'Lihat riwayat';
  ...
  String teacherHistorySuccess(num percent) {
    return '$percent% benar';
  }

  @override
  String get teacherHistoryNamesGone =>
      'Nama dari sesi ini telah dihapus (90 hari).';

  @override
  String get teacherMarksTitle => 'Nilai untuk disalin';

  @override
  String teacherMarksHint(num cards) {
    return 'Dari 20, atas $cards kartu sesi ini.';
  }

  @override
  String get teacherTeamsLabel => 'Tim';
  ...
  String get teacherLinkSpamHint =>
      'Tiba dalam semenit. Jika tidak ada, periksa folder spam. Masih belum ada? Tulis ke support@iqraquest.org.';
  ...
  String get classroomBoardHowToJoin =>
      'Buka IqraQuest, pilih «Kelas», lalu masukkan kode ini.';

  @override
  String classroomAnsweredCount(num answered, num total) {
    return '$answered / $total sudah menjawab';
  }
  ...
  @override
  String get classroomBoardWaitingFirst => 'Pertanyaan pertama segera datang';

  @override
  String classroomSuccessRate(num percent) {
    return '$percent% menjawab benar';
  }
