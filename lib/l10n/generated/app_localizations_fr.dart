...
class AppLocalizationsFr extends AppLocalizations {
  ...
  @override
  String get detailLabel => 'En détail';
  ...
  @override
  String get levelBeginner => 'Premiers pas';

  @override
  String get levelBeginnerHint =>
      'Premiers pas : les toutes premières bases, que chacun connaît déjà.';
  ...
  String get levelMixedHint =>
      'Mixte : chaque carte tire son niveau, des premiers pas à expert.';
  ...
  @override
  String get computerStrengthLabel => 'Force des adversaires';

  @override
  String get strengthLabelShort => 'Force';

  @override
  String get autoRidersNote => 'Cavaliers automatiques';
  ...
  String get questionLevelNote =>
      'Niveau des questions : étape suivante, par joueur.';
  ...
  @override
  String get courseCalm => 'Tranquille';

  @override
  String get courseLively => 'Animé';

  @override
  String get courseIntense => 'Intense';

  @override
  String get courseSquareOasis => 'Oasis : ton cheval y est à l\'abri';

  @override
  String get courseSquareKnowledge => 'Connaissance : +1 point de savoir';

  @override
  String get courseSquareChallenge =>
      'Défi : une question en plus pour +2 cases';

  @override
  String get courseSquareShortcut =>
      'Raccourci : une question difficile pour sauter en avant';

  @override
  String get courseSquareWisdom => 'Sagesse : un fait à découvrir et à garder';

  @override
  String get levelEasyHint =>
      'Facile : des questions simples sur ce qu\'on apprend en premier.';

  @override
  String get levelIntermediateHint =>
      'Intermédiaire : pour qui connaît déjà bien les histoires et les règles.';
  ...
  @override
  String get freeTourTitle => 'Tu as fait le tour des cartes gratuites';

  @override
  String freeTourBody(int free, int total) {
    return 'Les $free cartes gratuites vont maintenant se répéter. Premium ouvre les $total cartes, tous les parcours et les sauvegardes, en un seul achat.';
  }

  @override
  String freeTourCta(int total) {
    return 'Débloquer les $total cartes';
  }
  ...
  @override
  String get schoolMode => 'Mode École';
  ...
  String get teacherSignInHint =>
      'Entrez votre adresse : nous vous envoyons un lien pour entrer et choisir un nouveau mot de passe.';
  ...
  @override
  String get teacherScoringMode => 'Comptage des points';

  @override
  String get teacherScoringTeams => 'Par équipes';

  @override
  String get teacherScoringIndividual => 'Classement individuel';

  @override
  String get teacherScoringIndividualHint =>
      'Chaque prénom apparaît classé au tableau. Un classement montre le premier, mais aussi le dernier, devant toute la classe.';

  @override
  String get teacherTimer => 'Chronomètre';

  @override
  String get teacherTimerNone => 'Aucun — je révèle à la main';
  ...
  @override
  String get teacherLength => 'Longueur';

  @override
  String teacherLengthAll(num count) {
    return 'Leçon entière ($count cartes)';
  }

  @override
  String teacherLengthShort(num count) {
    return 'Les $count premières cartes';
  }

  @override
  String get teacherShuffle => 'Mélanger l’ordre des cartes';

  @override
  String get teacherShuffleHint =>
      'Une classe qui rejoue la même leçon ne répond plus de mémoire.';

  @override
  String get classroomScanToJoin => 'Scannez, ou entrez le code';

  @override
  String get classroomRanking => 'Classement';
  ...
  @override
  String get teacherPitchTitle => 'Faites jouer votre classe';

  @override
  String get teacherPitchBody =>
      'Vous choisissez une leçon. Un code s\'affiche au tableau. Vos élèves le tapent sur leur téléphone ou leur tablette et répondent aux questions, tous en même temps.';

  @override
  String get teacherPitchPointFree =>
      'Créez votre compte : 5 parties gratuites pour essayer';

  @override
  String get teacherPitchPointPlan =>
      'Ensuite, IqraQuest École : parties illimitées toute l\'année';

  @override
  String get teacherPitchPointPupils =>
      'Vos élèves rejoignent avec le code, sans créer de compte';
  ...
  String teacherAccountRooms(num used, num total) {
    String _temp0 = intl.Intl.pluralLogic(
      used,
      locale: localeName,
      other: '$used salles ouvertes sur $total',
      one: '$used salle ouverte sur $total',
    );
    return '$_temp0';
  }
  ...
  String get teacherRenewByEmail =>
      'Écrivez-nous pour renouveler : nous rouvrons votre espace le jour même.';
  ...
  @override
  String get teacherAccountEndingSoon => 'Votre abonnement se termine bientôt.';

  @override
  String get teacherAccountRenews => 'Le renouvellement est automatique.';

  @override
  String get teacherExpired => 'Votre abonnement est terminé';

  @override
  String get teacherExpiredHint =>
      'Aucune séance ne peut plus être ouverte. Votre historique reste consultable, et un renouvellement rouvre tout immédiatement.';

  @override
  String get teacherRenew => 'Renouveler l\'abonnement';

  @override
  String get teacherHistory => 'Séances passées';

  @override
  String get teacherHistoryOpen => 'Voir l\'historique';

  @override
  String get teacherHistoryEmpty => 'Aucune séance terminée pour l\'instant.';
  ...
  String get teacherHistoryNamesGone =>
      'Les prénoms de cette séance ont été effacés (90 jours).';

  @override
  String get teacherMarksTitle => 'Notes à reporter';

  @override
  String teacherMarksHint(num cards) {
    return 'Sur 20, calculé sur les $cards cartes de la séance.';
  }

  @override
  String get teacherTeamsLabel => 'Équipes';
  ...
  String get teacherLinkSpamHint =>
      'Il arrive en une minute. S\'il n\'est pas là, regardez dans les indésirables. Toujours rien ? Écrivez à support@iqraquest.org.';

  @override
  String get teacherTooManyLinks =>
      'Trop de liens demandés. Attendez une heure, ou vérifiez l\'envoi d\'e-mails du serveur.';
  ...
  String get classroomBoardHowToJoin =>
      'Ouvrez IqraQuest, choisissez « Classe » et entrez ce code.';

  @override
  String classroomAnsweredCount(num answered, num total) {
    return '$answered / $total ont répondu';
  }
  ...
  @override
  String get classroomToReview => 'À revoir ensemble';

  @override
  String get classroomBoardWaitingFirst => 'La première question arrive';

  @override
  String classroomSuccessRate(num percent) {
    return '$percent % de bonnes réponses';
  }
