...
class AppLocalizationsPt extends AppLocalizations {
  ...
  @override
  String get purchaseInProgress => 'Compra em curso…';
  ...
  String get premiumUnlockAll =>
      'Desbloqueia todas as cartas, todos os percursos, as partidas guardadas e o nível misto';
  ...
  @override
  String get computerStrengthLabel => 'Força dos adversários';

  @override
  String get strengthLabelShort => 'Força';

  @override
  String get autoRidersNote => 'Cavaleiros automáticos';
  ...
  String get questionLevelNote =>
      'Nível das perguntas: no passo seguinte, por jogador.';
  ...
  String premiumBenefitCourses(String lively, String intense) {
    return 'Os percursos $lively e $intense, com todas as suas casas especiais';
  }

  @override
  String get premiumBenefitSaves =>
      'Guardar várias partidas com um nome e retomá-las';

  @override
  String premiumBenefitMixed(String mixed) {
    return 'O nível $mixed: cada carta tira o seu próprio nível';
  }

  @override
  String get premiumBannerTitle => 'Passar a Premium';

  @override
  String get premiumBannerBody =>
      'Todas as cartas, todos os percursos, as partidas guardadas';

  @override
  String get premiumActive => 'Premium ativo: tudo desbloqueado';

  @override
  String get freeTourTitle => 'Já viste todas as cartas gratuitas';

  @override
  String freeTourBody(int free, int total) {
    return 'As $free cartas gratuitas vão agora repetir-se. O Premium abre as $total cartas, todos os percursos e os jogos guardados, numa única compra.';
  }

  @override
  String freeTourCta(int total) {
    return 'Desbloquear as $total cartas';
  }

  @override
  String get laterAction => 'Mais tarde';
  ...
  @override
  String get schoolMode => 'Modo Escola';
  ...
  String get teacherSignInHint =>
      'Introduza o seu endereço: enviamos-lhe um link para entrar e escolher uma nova palavra-passe.';
  ...
  String get teacherNoLicenceHint =>
      'A licença está ligada ao endereço que pagou. Se a compra foi feita com outro endereço, termine a sessão e use esse.';
  ...
  @override
  String get teacherScoringMode => 'Como os pontos são contados';

  @override
  String get teacherScoringTeams => 'Por equipas';

  @override
  String get teacherScoringIndividual => 'Classificação individual';

  @override
  String get teacherScoringIndividualHint =>
      'Cada nome aparece classificado no quadro. Uma classificação mostra o primeiro, mas também o último, diante de toda a turma.';

  @override
  String get teacherTimer => 'Cronómetro';

  @override
  String get teacherTimerNone => 'Nenhum — revelo à mão';
  ...
  @override
  String get teacherLength => 'Duração';

  @override
  String teacherLengthAll(num count) {
    return 'Lição completa ($count cartas)';
  }

  @override
  String teacherLengthShort(num count) {
    return 'As primeiras $count cartas';
  }

  @override
  String get teacherShuffle => 'Baralhar a ordem das cartas';

  @override
  String get teacherShuffleHint =>
      'Uma turma que repete a mesma lição deixa de responder de memória.';

  @override
  String get classroomScanToJoin => 'Digitalize ou introduza o código';

  @override
  String get classroomRanking => 'Classificação';
  ...
  @override
  String get teacherCreateAccount => 'Criar uma conta';

  @override
  String get teacherHaveAccount => 'Já tenho uma conta';

  @override
  String get teacherSignUpHint =>
      'Grátis, sem cartão. A sua conta recebe cinco partidas para experimentar o modo Escola.';

  @override
  String get teacherSignUpButton => 'Criar a minha conta';

  @override
  String get teacherAwaitingConfirmationTitle => 'Confirme o seu endereço';

  @override
  String teacherAwaitingConfirmationBody(String email) {
    return 'Acabámos de enviar um e-mail para $email. Abra o link que contém e volte para entrar.';
  }

  @override
  String get teacherEmailTaken =>
      'Este endereço já tem uma conta. Entre, ou use «Esqueceu-se da palavra-passe?».';

  @override
  String get teacherWeakPassword =>
      'A palavra-passe deve ter pelo menos seis caracteres.';

  @override
  String get teacherOfferDiscovery => 'Oferta de descoberta';
  ...
  String teacherFreeGamesLeft(num left, num total) {
    String _temp0 = intl.Intl.pluralLogic(
      left,
      locale: localeName,
      other: '$left / $total partidas grátis restantes',
      one: '$left / $total partida grátis restante',
    );
    return '$_temp0';
  }

  @override
  String get teacherQuotaTitle => 'As suas partidas grátis foram usadas';

  @override
  String get teacherQuotaBody =>
      'Usou as suas cinco partidas grátis. Passe para o IqraQuest École para criar partidas sem limite durante um ano.';

  @override
  String get teacherSubscribe => 'Subscrever o IqraQuest École';

  @override
  String get teacherSubscribeOnSite =>
      'A subscrição gere-se a partir da área da sua escola, num computador.';

  @override
  String teacherDevicesActive(num used, num total) {
    return 'Dispositivos ativos: $used / $total';
  }

  @override
  String get teacherPitchTitle => 'Ponha a sua turma a jogar';

  @override
  String get teacherPitchBody =>
      'Escolhe uma lição. Um código aparece no quadro. Os alunos escrevem-no no telemóvel ou no tablet e respondem às perguntas, todos ao mesmo tempo.';

  @override
  String get teacherPitchPointFree =>
      'Crie a sua conta: 5 partidas grátis para experimentar';

  @override
  String get teacherPitchPointPlan =>
      'Depois, IqraQuest École: partidas ilimitadas todo o ano';

  @override
  String get teacherPitchPointPupils =>
      'Os alunos entram com o código, sem criar conta';

  @override
  String get teacherSubscriptionTitle => 'Subscrição';

  @override
  String get teacherNoAccount =>
      'Não existe nenhuma conta com este endereço. Crie uma: é grátis.';

  @override
  String get teacherEmailNotConfirmed =>
      'O seu endereço ainda não está confirmado. Abra o link recebido por e-mail ou peça um novo.';

  @override
  String get teacherResendEmail => 'Reenviar o e-mail';

  @override
  String get teacherSchoolNameLabel => 'Nome da escola (opcional)';

  @override
  String get teacherSubscriptionActiveDelete =>
      'A sua subscrição ainda está ativa. Cancele-a primeiro em «Gerir a minha subscrição» e depois apague a conta.';

  @override
  String get teacherSetNewPasswordHint =>
      'Entrou através de um link. Escolha agora uma nova palavra-passe.';

  @override
  String get teacherManageDevices => 'Gerir os meus dispositivos';

  @override
  String get teacherDeviceLimitTitle => 'Limite de dispositivos atingido';

  @override
  String teacherDeviceLimitBody(num count) {
    return 'A sua licença permite $count sessões de jogo em simultâneo. Feche uma sessão noutro dispositivo ou desligue-o abaixo.';
  }

  @override
  String get teacherDisconnectDevice => 'Desligar';

  @override
  String get teacherNoActiveDevices =>
      'Nenhum dispositivo está a jogar neste momento.';
  ...
  @override
  String get teacherDeviceStale => 'Sem resposta — lugar libertado';

  @override
  String get teacherManageSubscription => 'Gerir a minha subscrição';

  @override
  String get teacherSubscriptionActive =>
      'A sua licença IqraQuest École está ativa.';

  @override
  String teacherCancelAtPeriodEnd(String date) {
    return 'Renovação cancelada. A sua licença continua ativa até $date.';
  }

  @override
  String get teacherPaymentFailedTitle => 'Problema de pagamento';

  @override
  String get teacherPaymentFailedBody =>
      'A sua subscrição precisa de um meio de pagamento atualizado. Uma sessão em curso pode terminar; a seguinte espera a regularização.';

  @override
  String get teacherUpdatePayment => 'Atualizar o meu meio de pagamento';

  @override
  String get teacherChangePassword => 'Alterar a minha palavra-passe';

  @override
  String get teacherNewPassword => 'Nova palavra-passe';

  @override
  String get teacherPasswordChanged => 'Palavra-passe alterada.';

  @override
  String get teacherDeleteAccount => 'Eliminar a minha conta';

  @override
  String get teacherDeleteAccountHint =>
      'O seu perfil, licença, sessões e relatórios serão apagados. As faturas ficam na Stripe, que é obrigada a guardá-las. Esta ação é definitiva.';

  @override
  String get teacherConfirmDelete => 'Sim, eliminar definitivamente';

  @override
  String get teacherNetworkNeeded =>
      'É necessária ligação para iniciar uma nova partida Escola.';

  @override
  String get teacherAccountSection => 'A minha conta';

  @override
  String get teacherPasswordLabel => 'Palavra-passe';

  @override
  String get teacherSignIn => 'Entrar';

  @override
  String get teacherSignInPasswordHint =>
      'Introduza o endereço da sua escola e a sua palavra-passe.';

  @override
  String get teacherBadCredentials => 'Endereço ou palavra-passe incorretos.';

  @override
  String get teacherForgotPassword => 'Esqueceu-se da palavra-passe?';
  ...
  String teacherAccountRooms(num used, num total) {
    String _temp0 = intl.Intl.pluralLogic(
      used,
      locale: localeName,
      other: '$used de $total salas abertas',
      one: '$used de $total salas aberta',
    );
    return '$_temp0';
  }
  ...
  String teacherAccountEndedOn(String date) {
    return 'Terminou a $date';
  }

  @override
  String get teacherRenewByEmail =>
      'Escreva-nos para renovar: reabrimos a sua área no próprio dia.';
  ...
  String get teacherLinkSpamHint =>
      'Chega num minuto. Se não estiver lá, veja a pasta de spam. Continua sem chegar? Escreva para support@iqraquest.org.';

  @override
  String get teacherTooManyLinks =>
      'Demasiados links pedidos. Espere uma hora ou verifique o envio de e-mail do servidor.';
  ...
  String get classroomBoardHowToJoin =>
      'Abra o IqraQuest, escolha «Turma» e introduza este código.';

  @override
  String classroomAnsweredCount(num answered, num total) {
    return '$answered / $total responderam';
  }
  ...
  @override
  String get classroomPodium => 'Pódio';

  @override
  String get classroomToReview => 'Para rever juntos';

  @override
  String get classroomBoardWaitingFirst => 'A primeira pergunta está a chegar';

  @override
  String classroomSuccessRate(num percent) {
    return '$percent% de respostas certas';
  }
