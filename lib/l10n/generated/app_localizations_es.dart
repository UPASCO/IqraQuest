...
class AppLocalizationsEs extends AppLocalizations {
  ...
  @override
  String get levelBeginner => 'Primeros pasos';

  @override
  String get levelBeginnerHint =>
      'Primeros pasos: lo más básico, lo que todo el mundo ya sabe.';
  ...
  String get levelMixedHint =>
      'Mixto: cada carta saca su nivel, de primeros pasos a experto.';
  ...
  @override
  String get computerStrengthLabel => 'Fuerza de los rivales';

  @override
  String get strengthLabelShort => 'Fuerza';

  @override
  String get autoRidersNote => 'Jinetes automáticos';
  ...
  String get questionLevelNote =>
      'Nivel de preguntas: en el paso siguiente, por jugador.';
  ...
  @override
  String get courseSquareOasis => 'Oasis: tu caballo está a salvo';

  @override
  String get courseSquareKnowledge => 'Conocimiento: +1 punto de saber';

  @override
  String get courseSquareChallenge =>
      'Desafío: una pregunta extra por +2 casillas';

  @override
  String get courseSquareShortcut =>
      'Atajo: una pregunta difícil para saltar adelante';

  @override
  String get courseSquareWisdom =>
      'Sabiduría: un dato para descubrir y guardar';

  @override
  String get levelEasyHint =>
      'Fácil: preguntas sencillas sobre lo que se aprende primero.';

  @override
  String get levelIntermediateHint =>
      'Intermedio: para quien ya conoce bien las historias y las reglas.';
  ...
  String get teacherSignInHint =>
      'Introduce tu dirección: te enviamos un enlace para entrar y elegir una nueva contraseña.';

  @override
  String get teacherEmailLabel => 'Correo electrónico';

  @override
  String get teacherSendLink => 'Enviarme el enlace';

  @override
  String teacherLinkSent(String email) {
    return 'Enlace enviado a $email. Ábrelo en este dispositivo.';
  }

  @override
  String get teacherInvalidEmail => 'Esto no parece una dirección de correo.';

  @override
  String get teacherNoLicence =>
      'No hay ninguna licencia asociada a esta dirección.';

  @override
  String get teacherNoLicenceHint =>
      'La licencia va ligada a la dirección que pagó. Si la compra se hizo con otra dirección, cierra sesión y usa esa.';

  @override
  String get teacherGetLicence => 'Obtener una licencia';

  @override
  String get teacherLicencePaidElsewhere =>
      'El pago se realiza en la página segura de Stripe; después, vuelve aquí.';

  @override
  String get teacherRefresh => 'Actualizar';

  @override
  String get teacherSignOut => 'Cerrar sesión';

  @override
  String teacherLicenceUntil(String date) {
    return 'Licencia válida hasta el $date';
  }

  @override
  String get teacherLicenceExpired => 'Licencia caducada';

  @override
  String get levelLabel => 'Nivel';

  @override
  String get teacherChooseLesson => 'Elegir la lección';

  @override
  String get teacherScoringMode => 'Cómo se cuentan los puntos';

  @override
  String get teacherScoringTeams => 'Por equipos';

  @override
  String get teacherScoringIndividual => 'Clasificación individual';

  @override
  String get teacherScoringIndividualHint =>
      'Cada nombre aparece clasificado en el tablero. Una clasificación muestra al primero, pero también al último, delante de toda la clase.';

  @override
  String get teacherTimer => 'Cronómetro';

  @override
  String get teacherTimerNone => 'Ninguno: revelo a mano';
  ...
  @override
  String get teacherLength => 'Duración';

  @override
  String teacherLengthAll(num count) {
    return 'Lección completa ($count cartas)';
  }

  @override
  String teacherLengthShort(num count) {
    return 'Las primeras $count cartas';
  }

  @override
  String get teacherShuffle => 'Mezclar el orden de las cartas';

  @override
  String get teacherShuffleHint =>
      'Una clase que repite la misma lección ya no responde de memoria.';

  @override
  String get classroomScanToJoin => 'Escánealo o escribe el código';

  @override
  String get classroomRanking => 'Clasificación';
  ...
  @override
  String get teacherCreateAccount => 'Crear una cuenta';

  @override
  String get teacherHaveAccount => 'Ya tengo una cuenta';

  @override
  String get teacherSignUpHint =>
      'Gratis, sin tarjeta. Tu cuenta recibe cinco partidas para probar el modo Escuela.';

  @override
  String get teacherSignUpButton => 'Crear mi cuenta';

  @override
  String get teacherAwaitingConfirmationTitle => 'Confirma tu dirección';

  @override
  String teacherAwaitingConfirmationBody(String email) {
    return 'Acabamos de enviar un correo a $email. Abre el enlace que contiene y vuelve a iniciar sesión.';
  }

  @override
  String get teacherEmailTaken =>
      'Esta dirección ya tiene una cuenta. Inicia sesión o usa «¿Olvidaste tu contraseña?».';
  ...
  @override
  String get teacherOfferDiscovery => 'Oferta de prueba';
  ...
  String teacherFreeGamesLeft(num left, num total) {
    String _temp0 = intl.Intl.pluralLogic(
      left,
      locale: localeName,
      other: '$left / $total partidas gratis restantes',
      one: '$left / $total partida gratis restante',
    );
    return '$_temp0';
  }

  @override
  String get teacherQuotaTitle => 'Has usado tus partidas gratis';

  @override
  String get teacherQuotaBody =>
      'Has usado tus cinco partidas gratis. Pasa a IqraQuest École para crear partidas sin límite durante un año.';

  @override
  String get teacherSubscribe => 'Suscribirse a IqraQuest École';

  @override
  String get teacherSubscribeOnSite =>
      'La suscripción se gestiona desde el espacio de tu centro, en un ordenador.';

  @override
  String teacherDevicesActive(num used, num total) {
    return 'Dispositivos activos: $used / $total';
  }

  @override
  String get teacherPitchTitle => 'Haz jugar a tu clase';

  @override
  String get teacherPitchBody =>
      'Eliges una lección. Aparece un código en la pizarra. Tus alumnos lo escriben en su teléfono o tableta y responden a las preguntas, todos a la vez.';

  @override
  String get teacherPitchPointFree =>
      'Crea tu cuenta: 5 partidas gratis para probar';

  @override
  String get teacherPitchPointPlan =>
      'Después, IqraQuest École: partidas ilimitadas todo el año';

  @override
  String get teacherPitchPointPupils =>
      'Tus alumnos se unen con el código, sin crear cuenta';

  @override
  String get teacherSubscriptionTitle => 'Suscripción';

  @override
  String get teacherNoAccount =>
      'No existe ninguna cuenta con esta dirección. Crea una: es gratis.';

  @override
  String get teacherEmailNotConfirmed =>
      'Tu dirección aún no está confirmada. Abre el enlace recibido por correo o pide uno nuevo.';

  @override
  String get teacherResendEmail => 'Reenviar el correo';

  @override
  String get teacherSchoolNameLabel => 'Nombre del centro (opcional)';

  @override
  String get teacherSubscriptionActiveDelete =>
      'Tu suscripción sigue activa. Cancélala primero desde «Gestionar mi suscripción» y luego elimina la cuenta.';

  @override
  String get teacherSetNewPasswordHint =>
      'Has entrado con un enlace. Elige ahora una nueva contraseña.';

  @override
  String get teacherManageDevices => 'Gestionar mis dispositivos';

  @override
  String get teacherDeviceLimitTitle => 'Límite de dispositivos alcanzado';

  @override
  String teacherDeviceLimitBody(num count) {
    return 'Tu licencia permite $count sesiones de juego simultáneas. Cierra una sesión en otro dispositivo o desconéctalo abajo.';
  }

  @override
  String get teacherDisconnectDevice => 'Desconectar';

  @override
  String get teacherNoActiveDevices => 'Ningún dispositivo está jugando ahora.';
  ...
  @override
  String get teacherDeviceStale => 'Sin respuesta — plaza liberada';

  @override
  String get teacherManageSubscription => 'Gestionar mi suscripción';

  @override
  String get teacherSubscriptionActive =>
      'Tu licencia IqraQuest École está activa.';

  @override
  String teacherCancelAtPeriodEnd(String date) {
    return 'Renovación cancelada. Tu licencia sigue activa hasta el $date.';
  }

  @override
  String get teacherPaymentFailedTitle => 'Problema de pago';

  @override
  String get teacherPaymentFailedBody =>
      'Tu suscripción necesita actualizar el medio de pago. Una sesión en curso puede terminar; la siguiente espera la regularización.';

  @override
  String get teacherUpdatePayment => 'Actualizar mi medio de pago';

  @override
  String get teacherChangePassword => 'Cambiar mi contraseña';

  @override
  String get teacherNewPassword => 'Nueva contraseña';

  @override
  String get teacherPasswordChanged => 'Contraseña cambiada.';

  @override
  String get teacherDeleteAccount => 'Eliminar mi cuenta';

  @override
  String get teacherDeleteAccountHint =>
      'Se borrarán tu perfil, tu licencia, tus sesiones y sus informes. Las facturas quedan en Stripe, que debe conservarlas. Esta acción es definitiva.';

  @override
  String get teacherConfirmDelete => 'Sí, eliminar definitivamente';

  @override
  String get teacherNetworkNeeded =>
      'Se necesita conexión para iniciar una nueva partida Escuela.';

  @override
  String get teacherAccountSection => 'Mi cuenta';

  @override
  String get teacherPasswordLabel => 'Contraseña';

  @override
  String get teacherSignIn => 'Iniciar sesión';

  @override
  String get teacherSignInPasswordHint =>
      'Introduce la dirección de tu centro y tu contraseña.';

  @override
  String get teacherBadCredentials => 'Dirección o contraseña incorrecta.';

  @override
  String get teacherForgotPassword => '¿Olvidaste tu contraseña?';

  @override
  String get teacherAccount => 'Tu suscripción';
  ...
  @override
  String get teacherAccountEndingSoon => 'Tu suscripción termina pronto.';

  @override
  String get teacherAccountRenews => 'Se renueva automáticamente.';

  @override
  String get teacherExpired => 'Tu suscripción ha terminado';

  @override
  String get teacherExpiredHint =>
      'Ya no se puede abrir ninguna sesión. Tu historial sigue ahí y renovar lo reabre todo de inmediato.';

  @override
  String get teacherRenew => 'Renovar la suscripción';

  @override
  String get teacherHistory => 'Sesiones anteriores';

  @override
  String get teacherHistoryOpen => 'Ver el historial';

  @override
  String get teacherHistoryEmpty => 'Aún no hay ninguna sesión terminada.';

  @override
  String teacherHistorySuccess(num percent) {
    return '$percent % de aciertos';
  }

  @override
  String get teacherHistoryNamesGone =>
      'Los nombres de esta sesión se borraron (90 días).';

  @override
  String get teacherMarksTitle => 'Notas para pasar';

  @override
  String teacherMarksHint(num cards) {
    return 'Sobre 20, con las $cards cartas de la sesión.';
  }

  @override
  String get teacherTeamsLabel => 'Equipos';
  ...
  @override
  String get teacherBoardLanguage => 'Idioma del tablero';

  @override
  String get teacherOpenSession => 'Abrir la sesión';

  @override
  String get teacherOpenBoard => 'Abrir el tablero';

  @override
  String get teacherNextQuestion => 'Siguiente pregunta';

  @override
  String get teacherRevealAnswer => 'Mostrar la respuesta';

  @override
  String get teacherEndSession => 'Terminar la sesión';

  @override
  String get teacherEndSessionHint =>
      'La sesión se cierra y los nombres de los alumnos se borran. Se conserva el resumen por pregunta.';

  @override
  String teacherTooManySessions(num limit) {
    return 'Esta licencia permite $limit sala(s) a la vez.';
  }

  @override
  String get teacherLinkSpamHint =>
      'Llega en un minuto. Si no está, mira en la carpeta de spam. ¿Sigue sin llegar? Escribe a support@iqraquest.org.';

  @override
  String get teacherTooManyLinks =>
      'Demasiados enlaces solicitados. Espera una hora o revisa el envío de correo del servidor.';

  @override
  String get teacherUnreachable =>
      'El servidor no responde. Inténtalo de nuevo en un momento.';

  @override
  String get teacherSessionRunning => 'Sesión en curso';

  @override
  String get classroomBoardCode => 'Código de la clase';

  @override
  String get classroomBoardHowToJoin =>
      'Abre IqraQuest, elige «Clase» e introduce este código.';

  @override
  String classroomAnsweredCount(num answered, num total) {
    return '$answered / $total han respondido';
  }
  ...
  @override
  String get classroomToReview => 'Para repasar juntos';

  @override
  String get classroomBoardWaitingFirst =>
      'La primera pregunta está por llegar';
