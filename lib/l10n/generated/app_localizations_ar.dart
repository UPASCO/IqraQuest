...
class AppLocalizationsAr extends AppLocalizations {
  ...
  @override
  String get teacherPitchTitle => 'أشرك صفّك في اللعب';

  @override
  String get teacherPitchBody =>
      'تختار درسًا. يظهر رمز على السبورة. يكتبه تلاميذك على هواتفهم أو أجهزتهم اللوحية ويجيبون عن الأسئلة، جميعهم في الوقت نفسه.';

  @override
  String get teacherPitchPointFree => 'أنشئ حسابك: 5 حصص مجانية للتجربة';

  @override
  String get teacherPitchPointPlan =>
      'ثم IqraQuest École: حصص غير محدودة طوال السنة';

  @override
  String get teacherPitchPointPupils => 'ينضم تلاميذك بالرمز، دون إنشاء حساب';
  ...
  String teacherAccountRooms(num used, num total) {
    String _temp0 = intl.Intl.pluralLogic(
      used,
      locale: localeName,
      other: '$used قاعة مفتوحة من $total',
      many: '$used قاعة مفتوحة من $total',
      few: '$used قاعات مفتوحة من $total',
      two: 'قاعتان مفتوحتان من $total',
      one: 'قاعة واحدة مفتوحة من $total',
      zero: 'لا قاعة مفتوحة من $total',
    );
    return '$_temp0';
  }
  ...
  String get teacherRenewByEmail =>
      'راسلنا للتجديد: نعيد فتح مساحتك في اليوم نفسه.';
  ...
  String get teacherTooManyLinks =>
      'طُلبت روابط كثيرة. انتظر ساعة، أو تحقق من إرسال البريد في الخادم.';
