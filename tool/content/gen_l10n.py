...
s("teacherSignInHint", "Console, forgot-password form: what happens next",
  fr="Entrez votre adresse : nous vous envoyons un lien pour entrer et choisir un nouveau mot de passe.",
  en="Enter your address: we send you a link to get in and choose a new password.",
  ar="أدخل عنوانك: نرسل لك رابطًا للدخول واختيار كلمة مرور جديدة.",
  es="Introduce tu dirección: te enviamos un enlace para entrar y elegir una nueva contraseña.",
  pt="Introduza o seu endereço: enviamos-lhe um link para entrar e escolher uma nova palavra-passe.",
  de="Gib deine Adresse ein: wir schicken dir einen Link zum Anmelden und für ein neues Passwort.",
  tr="Adresinizi girin: giriş yapıp yeni bir parola seçmeniz için size bir bağlantı gönderiyoruz.",
  id="Masukkan alamat Anda: kami mengirim tautan untuk masuk dan memilih kata sandi baru.",
  ur="اپنا پتہ درج کریں: ہم آپ کو داخل ہونے اور نیا پاس ورڈ چننے کا لنک بھیجتے ہیں۔",
  ms="Masukkan alamat anda: kami hantar pautan untuk masuk dan memilih kata laluan baharu.",
  it="Inserisci il tuo indirizzo: ti inviamo un link per entrare e scegliere una nuova password.",
  nl="Voer je adres in: we sturen je een link om binnen te komen en een nieuw wachtwoord te kiezen.")
...
s("teacherPitchTitle", "Console welcome panel: headline, plain words",
  fr="Faites jouer votre classe", en="Get your class playing",
  ar="أشرك صفّك في اللعب", es="Haz jugar a tu clase",
  pt="Ponha a sua turma a jogar", de="Lassen Sie Ihre Klasse spielen",
  tr="Sınıfınızı oynatın", id="Ajak kelas Anda bermain",
  ur="اپنی کلاس کو کھلائیں", ms="Ajak kelas anda bermain",
  it="Fai giocare la tua classe", nl="Laat uw klas spelen")

s("teacherPitchBody", "Console welcome panel: how a session works, in one breath",
  fr="Vous choisissez une leçon. Un code s'affiche au tableau. Vos élèves le tapent sur leur téléphone ou leur tablette et répondent aux questions, tous en même temps.",
  en="You pick a lesson. A code appears on the board. Your pupils type it on their phone or tablet and answer the questions, all at the same time.",
  ar="تختار درسًا. يظهر رمز على السبورة. يكتبه تلاميذك على هواتفهم أو أجهزتهم اللوحية ويجيبون عن الأسئلة، جميعهم في الوقت نفسه.",
  es="Eliges una lección. Aparece un código en la pizarra. Tus alumnos lo escriben en su teléfono o tableta y responden a las preguntas, todos a la vez.",
  pt="Escolhe uma lição. Um código aparece no quadro. Os alunos escrevem-no no telemóvel ou no tablet e respondem às perguntas, todos ao mesmo tempo.",
  de="Sie wählen eine Lektion. An der Tafel erscheint ein Code. Ihre Schüler tippen ihn auf Handy oder Tablet ein und beantworten die Fragen – alle gleichzeitig.",
  tr="Bir ders seçersiniz. Tahtada bir kod belirir. Öğrencileriniz kodu telefon ya da tabletlerine yazar ve soruları hep birlikte yanıtlar.",
  id="Anda memilih pelajaran. Sebuah kode muncul di papan. Murid mengetiknya di ponsel atau tablet dan menjawab pertanyaan, semuanya bersamaan.",
  ur="آپ ایک سبق چنتے ہیں۔ بورڈ پر ایک کوڈ ظاہر ہوتا ہے۔ آپ کے طلبہ اسے اپنے فون یا ٹیبلٹ پر لکھتے ہیں اور سب ایک ساتھ سوالوں کے جواب دیتے ہیں۔",
  ms="Anda pilih pelajaran. Satu kod muncul di papan. Murid menaipnya di telefon atau tablet dan menjawab soalan, semuanya serentak.",
  it="Scegli una lezione. Alla lavagna compare un codice. Gli alunni lo digitano sul telefono o sul tablet e rispondono alle domande, tutti insieme.",
  nl="U kiest een les. Op het bord verschijnt een code. Uw leerlingen typen die op hun telefoon of tablet en beantwoorden de vragen, allemaal tegelijk.")

s("teacherPitchPointFree", "Console welcome panel: what a new account gives",
  fr="Créez votre compte : 5 parties gratuites pour essayer",
  en="Create your account: 5 free games to try it out",
  ar="أنشئ حسابك: 5 حصص مجانية للتجربة",
  es="Crea tu cuenta: 5 partidas gratis para probar",
  pt="Crie a sua conta: 5 partidas grátis para experimentar",
  de="Konto anlegen: 5 Gratisspiele zum Ausprobieren",
  tr="Hesabınızı oluşturun: denemek için 5 ücretsiz oyun",
  id="Buat akun Anda: 5 permainan gratis untuk mencoba",
  ur="اپنا اکاؤنٹ بنائیں: آزمانے کے لیے 5 مفت کھیل",
  ms="Cipta akaun anda: 5 permainan percuma untuk mencuba",
  it="Crea il tuo account: 5 partite gratis per provare",
  nl="Maak uw account aan: 5 gratis spellen om te proberen")

s("teacherPitchPointPlan", "Console welcome panel: what comes after the free games (no price)",
  fr="Ensuite, IqraQuest École : parties illimitées toute l'année",
  en="Then IqraQuest École: unlimited games all year",
  ar="ثم IqraQuest École: حصص غير محدودة طوال السنة",
  es="Después, IqraQuest École: partidas ilimitadas todo el año",
  pt="Depois, IqraQuest École: partidas ilimitadas todo o ano",
  de="Danach IqraQuest École: unbegrenzt spielen, das ganze Jahr",
  tr="Sonra IqraQuest École: yıl boyunca sınırsız oyun",
  id="Lalu IqraQuest École: permainan tanpa batas sepanjang tahun",
  ur="پھر IqraQuest École: سال بھر لامحدود کھیل",
  ms="Kemudian IqraQuest École: permainan tanpa had sepanjang tahun",
  it="Poi IqraQuest École: partite illimitate tutto l'anno",
  nl="Daarna IqraQuest École: onbeperkt spelen, het hele jaar")

s("teacherPitchPointPupils", "Console welcome panel: how pupils join",
  fr="Vos élèves rejoignent avec le code, sans créer de compte",
  en="Your pupils join with the code, no account needed",
  ar="ينضم تلاميذك بالرمز، دون إنشاء حساب",
  es="Tus alumnos se unen con el código, sin crear cuenta",
  pt="Os alunos entram com o código, sem criar conta",
  de="Ihre Schüler machen mit dem Code mit, ganz ohne Konto",
  tr="Öğrencileriniz kodla katılır, hesap açmadan",
  id="Murid bergabung dengan kode, tanpa membuat akun",
  ur="آپ کے طلبہ کوڈ سے شامل ہوتے ہیں، بغیر اکاؤنٹ بنائے",
  ms="Murid menyertai dengan kod, tanpa mencipta akaun",
  it="Gli alunni entrano con il codice, senza creare un account",
  nl="Uw leerlingen doen mee met de code, zonder account")
...
s("teacherAccount", "Console: the heading of the subscription card",
  ...
  tr="Aboneliğiniz", id="Langganan Anda", ur="آپ کی رکنیت",
  ms="Langganan anda", it="Il tuo abbonamento", nl="Je abonnement")

s("teacherAccountRooms", "Console: how many rooms the plan opens, and how many run now",
  ph={"used": "num", "total": "num"},
  fr="{used, plural, one{{used} salle ouverte sur {total}} other{{used} salles ouvertes sur {total}}}",
  en="{used, plural, one{{used} of {total} rooms open} other{{used} of {total} rooms open}}",
  ar="{used, plural, zero{لا قاعة مفتوحة من {total}} one{قاعة واحدة مفتوحة من {total}} two{قاعتان مفتوحتان من {total}} few{{used} قاعات مفتوحة من {total}} many{{used} قاعة مفتوحة من {total}} other{{used} قاعة مفتوحة من {total}}}",
  es="{used, plural, one{{used} de {total} salas abierta} other{{used} de {total} salas abiertas}}",
  pt="{used, plural, one{{used} de {total} salas aberta} other{{used} de {total} salas abertas}}",
  de="{used, plural, one{{used} von {total} Räumen offen} other{{used} von {total} Räumen offen}}",
  tr="{used, plural, other{{total} salondan {used} tanesi açık}}",
  id="{used, plural, other{{used} dari {total} ruang terbuka}}",
  ur="{used, plural, one{{total} میں سے {used} کمرہ کھلا} other{{total} میں سے {used} کمرے کھلے}}",
  ms="{used, plural, other{{used} daripada {total} bilik dibuka}}",
  it="{used, plural, one{{used} di {total} sale aperta} other{{used} di {total} sale aperte}}",
  nl="{used, plural, one{{used} van {total} zalen open} other{{used} van {total} zalen open}}")

s("teacherAccountEndedOn", "Console: the date a finished subscription ran out",
  ph={"date": "String"},
  fr="Terminé le {date}", en="Ended on {date}", ar="انتهى في {date}",
  es="Terminó el {date}", pt="Terminou a {date}", de="Beendet am {date}",
  tr="{date} tarihinde sona erdi", id="Berakhir pada {date}",
  ur="{date} کو ختم ہوا", ms="Tamat pada {date}",
  it="Terminato il {date}", nl="Afgelopen op {date}")

s("teacherRenewByEmail", "Console: how to renew when there is no payment link",
  fr="Écrivez-nous pour renouveler : nous rouvrons votre espace le jour même.",
  en="Write to us to renew: we reopen your account the same day.",
  ar="راسلنا للتجديد: نعيد فتح مساحتك في اليوم نفسه.",
  es="Escríbenos para renovar: reabrimos tu espacio el mismo día.",
  pt="Escreva-nos para renovar: reabrimos a sua área no próprio dia.",
  de="Schreib uns zum Verlängern: wir öffnen deinen Bereich noch am selben Tag.",
  tr="Yenilemek için bize yazın: alanınızı aynı gün yeniden açarız.",
  id="Tulis kepada kami untuk memperpanjang: ruang Anda kami buka kembali hari itu juga.",
  ur="تجدید کے لیے ہمیں لکھیں: ہم اسی دن آپ کی جگہ دوبارہ کھول دیتے ہیں۔",
  ms="Tulis kepada kami untuk memperbaharui: kami buka semula ruang anda pada hari yang sama.",
  it="Scrivici per rinnovare: riapriamo la tua area il giorno stesso.",
  nl="Schrijf ons om te verlengen: we openen je ruimte dezelfde dag weer.")

s("teacherAccountDaysLeft", "Console: days remaining on the subscription",
  ph={"count": "num"},
  fr="{count, plural, one{Encore {count} jour} other{Encore {count} jours}}",
  en="{count, plural, one{{count} day left} other{{count} days left}}",
  ar="{count, plural, zero{لم يتبق شيء} one{يوم واحد متبقٍ} two{يومان متبقيان} few{{count} أيام متبقية} many{{count} يومًا متبقيًا} other{{count} يوم متبقٍ}}",
  es="{count, plural, one{Queda {count} día} other{Quedan {count} días}}",
  pt="{count, plural, one{Falta {count} dia} other{Faltam {count} dias}}",
  de="{count, plural, one{Noch {count} Tag} other{Noch {count} Tage}}",
  tr="{count, plural, other{{count} gün kaldı}}",
  id="{count, plural, other{Tersisa {count} hari}}",
  ur="{count, plural, one{{count} دن باقی} other{{count} دن باقی}}",
  ms="{count, plural, other{Tinggal {count} hari}}",
  it="{count, plural, one{Ancora {count} giorno} other{Ancora {count} giorni}}",
  nl="{count, plural, one{Nog {count} dag} other{Nog {count} dagen}}")

s("teacherAccountEndingSoon", "Console: the subscription is close to its end",
  fr="Votre abonnement se termine bientôt.",
  en="Your subscription ends soon.",
  ar="اشتراكك ينتهي قريبًا.",
  es="Tu suscripción termina pronto.",
  pt="A sua subscrição termina em breve.",
  de="Dein Abonnement endet bald.",
  tr="Aboneliğiniz yakında bitiyor.",
  id="Langganan Anda segera berakhir.",
  ur="آپ کی رکنیت جلد ختم ہو رہی ہے۔",
  ms="Langganan anda akan tamat tidak lama lagi.",
  it="Il tuo abbonamento sta per finire.",
  nl="Je abonnement loopt binnenkort af.")

s("teacherAccountRenews", "Console: the subscription renews by itself",
  fr="Le renouvellement est automatique.",
  en="It renews automatically.",
  ar="يتجدد تلقائيًا.",
  es="Se renueva automáticamente.",
  pt="Renova-se automaticamente.",
  de="Es verlängert sich automatisch.",
  tr="Otomatik olarak yenilenir.",
  id="Diperpanjang otomatis.",
  ur="یہ خودکار طور پر تجدید ہوتی ہے۔",
  ms="Ia diperbaharui secara automatik.",
  it="Si rinnova automaticamente.",
  nl="Het wordt automatisch verlengd.")

s("teacherExpired", "Console: the subscription is over, nothing opens",
  fr="Votre abonnement est terminé",
  en="Your subscription has ended",
  ar="انتهى اشتراكك",
  es="Tu suscripción ha terminado",
  pt="A sua subscrição terminou",
  de="Dein Abonnement ist beendet",
  tr="Aboneliğiniz sona erdi",
  id="Langganan Anda telah berakhir",
  ur="آپ کی رکنیت ختم ہو چکی ہے",
  ms="Langganan anda telah tamat",
  it="Il tuo abbonamento è terminato",
  nl="Je abonnement is afgelopen")

s("teacherExpiredHint", "Console: what is and is not lost when the subscription ends",
  fr="Aucune séance ne peut plus être ouverte. Votre historique reste consultable, et un renouvellement rouvre tout immédiatement.",
  en="No session can be opened any more. Your history is still there, and renewing reopens everything at once.",
  ar="لم يعد بالإمكان فتح أي حصة. سجلك ما زال موجودًا، والتجديد يعيد فتح كل شيء فورًا.",
  es="Ya no se puede abrir ninguna sesión. Tu historial sigue ahí y renovar lo reabre todo de inmediato.",
  pt="Já não é possível abrir sessões. O seu histórico continua lá, e renovar reabre tudo de imediato.",
  de="Es lässt sich keine Sitzung mehr öffnen. Dein Verlauf bleibt erhalten, und eine Verlängerung öffnet sofort wieder alles.",
  tr="Artık oturum açılamıyor. Geçmişiniz duruyor ve yenileme her şeyi anında yeniden açar.",
  id="Tidak ada sesi yang bisa dibuka lagi. Riwayat Anda tetap ada, dan perpanjangan membuka semuanya kembali seketika.",
  ur="اب کوئی نشست نہیں کھولی جا سکتی۔ آپ کی تاریخ محفوظ ہے، اور تجدید سب کچھ فوراً دوبارہ کھول دیتی ہے۔",
  ms="Tiada sesi boleh dibuka lagi. Sejarah anda masih ada, dan pembaharuan membuka semula semuanya serta-merta.",
  it="Non è più possibile aprire sessioni. Il tuo storico resta, e il rinnovo riapre tutto subito.",
  nl="Er kan geen sessie meer worden geopend. Je geschiedenis blijft bestaan en verlengen opent alles meteen weer.")

s("teacherRenew", "Console: the button that renews the subscription",
  fr="Renouveler l'abonnement", en="Renew the subscription",
  ar="تجديد الاشتراك", es="Renovar la suscripción",
  pt="Renovar a subscrição", de="Abonnement verlängern",
  tr="Aboneliği yenile", id="Perpanjang langganan",
  ur="رکنیت کی تجدید کریں", ms="Perbaharui langganan",
  it="Rinnova l'abbonamento", nl="Abonnement verlengen")

s("teacherHistory", "Console: the heading of the past sessions",
  fr="Séances passées", en="Past sessions", ar="الحصص السابقة",
  es="Sesiones anteriores", pt="Sessões anteriores",
  de="Vergangene Sitzungen", tr="Geçmiş oturumlar",
  id="Sesi sebelumnya", ur="گزشتہ نشستیں", ms="Sesi lepas",
  it="Sessioni passate", nl="Eerdere sessies")

s("teacherHistoryOpen", "Console: the button that loads the past sessions",
  fr="Voir l'historique", en="See the history", ar="عرض السجل",
  es="Ver el historial", pt="Ver o histórico", de="Verlauf ansehen",
  tr="Geçmişi gör", id="Lihat riwayat", ur="تاریخ دیکھیں",
  ms="Lihat sejarah", it="Vedi lo storico", nl="Bekijk de geschiedenis")

s("teacherHistoryEmpty", "Console: no session has been played yet",
  fr="Aucune séance terminée pour l'instant.",
  en="No finished session yet.",
  ar="لا توجد حصة منتهية بعد.",
  es="Aún no hay ninguna sesión terminada.",
  pt="Ainda não há sessões terminadas.",
  de="Noch keine abgeschlossene Sitzung.",
  tr="Henüz tamamlanmış oturum yok.",
  id="Belum ada sesi yang selesai.",
  ur="ابھی تک کوئی مکمل نشست نہیں۔",
  ms="Belum ada sesi yang selesai.",
  it="Nessuna sessione conclusa per ora.",
  nl="Nog geen afgeronde sessie.")

s("teacherHistorySuccess", "Console: how much of a past session the class got right",
  ph={"percent": "num"},
  fr="{percent} % de réussite", en="{percent}% correct",
  ar="{percent}% إجابات صحيحة", es="{percent} % de aciertos",
  pt="{percent} % de acertos", de="{percent} % richtig",
  tr="%{percent} doğru", id="{percent}% benar",
  ur="{percent}% درست", ms="{percent}% betul",
  it="{percent} % di risposte esatte", nl="{percent} % goed")

s("teacherHistoryNamesGone", "Console: the pupils' names have been erased by the retention rule",
  fr="Les prénoms de cette séance ont été effacés (90 jours).",
  en="The names from this session were erased (90 days).",
  ar="حُذفت أسماء هذه الحصة (٩٠ يومًا).",
  es="Los nombres de esta sesión se borraron (90 días).",
  pt="Os nomes desta sessão foram apagados (90 dias).",
  de="Die Namen dieser Sitzung wurden gelöscht (90 Tage).",
  tr="Bu oturumun adları silindi (90 gün).",
  id="Nama dari sesi ini telah dihapus (90 hari).",
  ur="اس نشست کے نام مٹا دیے گئے (۹۰ دن)۔",
  ms="Nama daripada sesi ini telah dipadam (90 hari).",
  it="I nomi di questa sessione sono stati cancellati (90 giorni).",
  nl="De namen van deze sessie zijn gewist (90 dagen).")

s("teacherMarksTitle", "Console: the sheet of marks a teacher copies into the register",
  fr="Notes à reporter", en="Marks to copy across",
  ar="العلامات للنقل", es="Notas para pasar",
  pt="Notas a transcrever", de="Noten zum Übertragen",
  tr="Deftere geçirilecek notlar", id="Nilai untuk disalin",
  ur="نقل کرنے کے لیے نمبر", ms="Markah untuk disalin",
  it="Voti da riportare", nl="Cijfers om over te nemen")

s("teacherMarksHint", "Console: how the mark out of twenty is worked out",
  ph={"cards": "num"},
  fr="Sur 20, calculé sur les {cards} cartes de la séance.",
  en="Out of 20, over the {cards} cards of the session.",
  ar="من ٢٠، على {cards} بطاقة في الحصة.",
  es="Sobre 20, con las {cards} cartas de la sesión.",
  pt="Em 20, sobre as {cards} cartas da sessão.",
  de="Von 20, über die {cards} Karten der Sitzung.",
  tr="20 üzerinden, oturumun {cards} kartı üzerinden.",
  id="Dari 20, atas {cards} kartu sesi ini.",
  ur="۲۰ میں سے، نشست کے {cards} کارڈوں پر۔",
  ms="Daripada 20, atas {cards} kad sesi ini.",
  it="Su 20, sulle {cards} carte della sessione.",
  nl="Op 20, over de {cards} kaarten van de sessie.")
...
s("teacherLinkSpamHint", "Console: where to look if the link is not in the inbox, and whom to write to",
  fr="Il arrive en une minute. S'il n'est pas là, regardez dans les indésirables. Toujours rien ? Écrivez à support@iqraquest.org.",
  en="It arrives within a minute. If it is not there, look in your spam folder. Still nothing? Write to support@iqraquest.org.",
  ar="يصل خلال دقيقة. إن لم تجده، فابحث في البريد غير المرغوب فيه. لا شيء بعد؟ راسل support@iqraquest.org.",
  es="Llega en un minuto. Si no está, mira en la carpeta de spam. ¿Sigue sin llegar? Escribe a support@iqraquest.org.",
  pt="Chega num minuto. Se não estiver lá, veja a pasta de spam. Continua sem chegar? Escreva para support@iqraquest.org.",
  de="Er kommt innerhalb einer Minute. Wenn nicht, sieh im Spam-Ordner nach. Immer noch nichts? Schreib an support@iqraquest.org.",
  tr="Bir dakika içinde gelir. Gelmediyse istenmeyen posta klasörüne bakın. Hâlâ yok mu? support@iqraquest.org adresine yazın.",
  id="Tiba dalam semenit. Jika tidak ada, periksa folder spam. Masih belum ada? Tulis ke support@iqraquest.org.",
  ur="ایک منٹ میں پہنچ جاتا ہے۔ نہ ملے تو اسپیم فولڈر دیکھیں۔ پھر بھی کچھ نہیں؟ support@iqraquest.org پر لکھیں۔",
  ms="Tiba dalam seminit. Jika tiada, semak folder spam. Masih tiada? Tulis ke support@iqraquest.org.",
  it="Arriva entro un minuto. Se non c'è, guarda nella posta indesiderata. Ancora niente? Scrivi a support@iqraquest.org.",
  nl="Hij komt binnen een minuut. Staat hij er niet, kijk dan in je spammap. Nog steeds niets? Schrijf naar support@iqraquest.org.")

s("teacherTooManyLinks", "Console: the mail service refused another link for now",
  fr="Trop de liens demandés. Attendez une heure, ou vérifiez l'envoi d'e-mails du serveur.",
  en="Too many links requested. Wait an hour, or check the server's email sending.",
  ar="طُلبت روابط كثيرة. انتظر ساعة، أو تحقق من إرسال البريد في الخادم.",
  es="Demasiados enlaces solicitados. Espera una hora o revisa el envío de correo del servidor.",
  pt="Demasiados links pedidos. Espere uma hora ou verifique o envio de e-mail do servidor.",
  de="Zu viele Links angefordert. Warte eine Stunde oder prüfe den E-Mail-Versand des Servers.",
  tr="Çok fazla bağlantı istendi. Bir saat bekleyin veya sunucunun e-posta gönderimini kontrol edin.",
  id="Terlalu banyak tautan diminta. Tunggu satu jam, atau periksa pengiriman email server.",
  ur="بہت زیادہ لنکس مانگے گئے۔ ایک گھنٹہ انتظار کریں، یا سرور کی ای میل ترسیل جانچیں۔",
  ms="Terlalu banyak pautan diminta. Tunggu sejam, atau semak penghantaran e-mel pelayan.",
  it="Troppi link richiesti. Aspetta un'ora o controlla l'invio di e-mail del server.",
  nl="Te veel links aangevraagd. Wacht een uur of controleer de e-mailverzending van de server.")
