...
s("teacherLinkSpamHint", "Console: where to look if the link is not in the inbox",
  fr="Il arrive en une minute. S'il n'est pas là, regardez dans les indésirables.",
  en="It arrives within a minute. If it is not there, look in your spam folder.",
  ar="يصل خلال دقيقة. إن لم تجده، فابحث في البريد غير المرغوب فيه.",
  es="Llega en un minuto. Si no está, mira en la carpeta de spam.",
  pt="Chega num minuto. Se não estiver lá, veja na pasta de spam.",
  de="Er kommt binnen einer Minute an. Falls nicht, schau im Spam-Ordner nach.",
  tr="Bir dakika içinde gelir. Gelmediyse gereksiz klasörüne bakın.",
  id="Tiba dalam satu menit. Jika tidak ada, periksa folder spam.",
  ur="ایک منٹ میں آ جاتا ہے۔ نہ ملے تو اسپیم فولڈر دیکھیں۔",
  ms="Tiba dalam satu minit. Jika tiada, semak folder spam.",
  it="Arriva entro un minuto. Se non c'è, guarda nella posta indesiderata.",
  nl="Hij komt binnen een minuut aan. Zo niet, kijk in je spammap.")
