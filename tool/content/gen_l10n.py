...
s("teacherAccountRooms", "Console: how many rooms the plan opens, and how many run now",
  ...
  fr="{used} salle(s) ouverte(s) sur {total}",
  en="{used} of {total} rooms open",
  ar="{used} من {total} قاعة مفتوحة",
  es="{used} de {total} salas abiertas",
  pt="{used} de {total} salas abertas",
  de="{used} von {total} Räumen offen",
  tr="{total} salondan {used} tanesi açık",
  id="{used} dari {total} ruang terbuka",
  ur="{total} میں سے {used} کمرے کھلے",
  ms="{used} daripada {total} bilik dibuka",
  it="{used} di {total} sale aperte",
  nl="{used} van {total} zalen open")
