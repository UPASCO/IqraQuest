...
s("ruleExitBody", "Rules step body: one horse already out, the other three on a 6",
  ...
  en="Each player has four horses, and the first is already on its start square: you play from the very first card, with nothing to wait for. The other three leave the stable on a 6: answer correctly and the horse takes the start square — and since a 6 plays again, it rides right away. The choice is yours: bring another out, or ride.",
  ar="لكل لاعب أربعة أحصنة، والأول منها يقف أصلًا على مربع الانطلاق: تلعب منذ البطاقة الأولى دون انتظار. أما الثلاثة الباقية فتخرج من الإسطبل بالرقم 6: أجب إجابة صحيحة ليقف الحصان على مربع الانطلاق — ولأن الرقم 6 يعيد اللعب، ينطلق فورًا. والاختيار لك: إخراج آخر أو التقدّم.",
  es="Cada jugador tiene cuatro caballos, y el primero ya está en su casilla de salida: juegas desde la primera carta, sin esperar. Los otros tres salen del establo con un 6: responde bien y el caballo ocupa la casilla de salida — y como el 6 hace jugar otra vez, sale enseguida. Tú eliges: sacar otro o avanzar.",
  pt="Cada jogador tem quatro cavalos, e o primeiro já está na casa de saída: você joga desde a primeira carta, sem esperar. Os outros três saem do estábulo com um 6: responda certo e o cavalo ocupa a casa de saída — e como o 6 faz jogar de novo, ele parte na hora. A escolha é sua: tirar outro ou avançar.",
  de="Jeder Spieler hat vier Pferde, und das erste steht schon auf seinem Startfeld: Du spielst ab der allerersten Karte, ohne zu warten. Die anderen drei verlassen den Stall mit einer 6: Antworte richtig, und das Pferd nimmt das Startfeld — und da die 6 noch einmal ziehen lässt, reitet es sofort los. Du entscheidest: noch eines herausholen oder reiten.",
  tr="Her oyuncunun dört atı vardır ve ilki başlangıç karesinde hazır bekler: ilk karttan itibaren oynarsın, beklemeden. Diğer üçü ahırdan 6 ile çıkar: doğru cevapla, at başlangıç karesine yerleşir — ve 6 yeniden oynattığı için hemen yola koyulur. Seçim senin: bir at daha çıkar ya da ilerle.",
  ...
  ur="ہر کھلاڑی کے چار گھوڑے ہیں، اور پہلا پہلے ہی اپنے آغاز کے خانے پر کھڑا ہے: آپ پہلی ہی کارڈ سے کھیلتے ہیں، بغیر انتظار کے۔ باقی تین اصطبل سے 6 پر نکلتے ہیں: درست جواب دیں اور گھوڑا آغاز کے خانے پر آ جاتا ہے — اور چونکہ 6 دوبارہ کھلاتا ہے، وہ فوراً روانہ ہو جاتا ہے۔ فیصلہ آپ کا: ایک اور نکالیں یا آگے بڑھیں۔",
  ms="Setiap pemain mempunyai empat kuda, dan yang pertama sudah berada di petak permulaannya: anda bermain sejak kad pertama, tanpa menunggu. Tiga yang lain keluar dari kandang dengan nombor 6: jawab betul dan kuda mengambil petak permulaan — dan kerana 6 membolehkan bermain lagi, ia terus bergerak. Pilihan anda: keluarkan satu lagi, atau mara.",
...
s("ruleStreakBody", "Rules step 5 body",
  ...
  en="Three correct answers in a row earn a shield, five the Grand Gallop, and ten a mastery badge. The Grand Gallop spends itself, and only when its +2 squares are enough to reach the finish. Bonuses come from knowledge alone.",
  ar="ثلاث إجابات صحيحة متتالية تمنح درعًا، وخمس تمنح الركض الكبير، وعشر تمنح شارة إتقان. يُصرف الركض الكبير تلقائيًا، وفقط حين تكفي مربعاته الاثنان لبلوغ النهاية. المكافآت تأتي من المعرفة وحدها.",
  es="Tres respuestas correctas seguidas dan un escudo, cinco el Gran Galope y diez una insignia de maestría. El Gran Galope se gasta solo, y únicamente cuando sus +2 casillas bastan para llegar a la meta. Las bonificaciones vienen solo del conocimiento.",
  pt="Três respostas certas seguidas dão um escudo, cinco o Grande Galope e dez uma medalha de maestria. O Grande Galope é gasto sozinho, e só quando suas +2 casas bastam para chegar ao fim. Os bônus vêm apenas do conhecimento.",
  de="Drei richtige Antworten hintereinander bringen einen Schild, fünf den Großen Galopp und zehn ein Meisterabzeichen. Der Große Galopp wird von selbst eingesetzt, und nur wenn seine +2 Felder zum Ziel reichen. Boni kommen allein aus Wissen.",
  tr="Üst üste üç doğru cevap bir kalkan, beş Büyük Dörtnal, on ise ustalık rozeti kazandırır. Büyük Dörtnal kendiliğinden harcanır ve yalnızca +2 karesi bitişe ulaşmaya yettiğinde. Bonuslar yalnızca bilgiden gelir.",
  id="Tiga jawaban benar berturut-turut memberi perisai, lima memberi Grand Galop, dan sepuluh memberi lencana penguasaan. Grand Galop terpakai sendiri, dan hanya bila +2 petaknya cukup untuk mencapai garis akhir. Bonus hanya datang dari pengetahuan.",
  ur="لگاتار تین درست جواب ایک ڈھال دیتے ہیں، پانچ گرینڈ گیلپ اور دس مہارت کا بیج۔ گرینڈ گیلپ خود خرچ ہوتا ہے، اور صرف تب جب اس کے +2 خانے اختتام تک پہنچنے کے لیے کافی ہوں۔ بونس صرف علم سے ملتے ہیں۔",
  ms="Tiga jawapan betul berturut-turut memberi perisai, lima memberi Grand Galop, dan sepuluh lencana penguasaan. Grand Galop dibelanjakan sendiri, dan hanya apabila +2 petaknya cukup untuk sampai ke penamat. Bonus datang daripada pengetahuan sahaja.",
  it="Tre risposte giuste di fila danno uno scudo, cinque il Gran Galoppo e dieci un distintivo di maestria. Il Gran Galoppo si spende da solo, e solo quando le sue +2 caselle bastano a tagliare il traguardo. I bonus vengono solo dalla conoscenza.",
  nl="Drie goede antwoorden op rij geven een schild, vijf de Grote Galop en tien een meesterschapsbadge. De Grote Galop wordt vanzelf ingezet, en alleen als zijn +2 vakjes genoeg zijn om de finish te halen. Bonussen komen alleen uit kennis.")
