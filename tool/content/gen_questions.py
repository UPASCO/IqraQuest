...
add("quran_011", "quran", "medium", "quran", "Quran", "2:255", False,
    fr=L("Quel est le nom du célèbre verset 255 de la sourate Al-Baqara ?",
         ["Âyat al-Kursî (le verset du Trône)", "Âyat an-Nûr", "Âyat as-Sayf", "Âyat ad-Dayn"], 0,
    ...
    en=L("What is the famous verse 255 of Surah Al-Baqarah called?",
         ["Ayat al-Kursi (the Throne Verse)", "Ayat an-Nur", "Ayat as-Sayf", "Ayat ad-Dayn"], 0,
    ...
    ar=L("ما اسم الآية 255 المشهورة من سورة البقرة؟",
         ["آية الكرسي", "آية النور", "آية السيف", "آية الدَّين"], 0,
...
add("sira_024", "sira", "hard", "sira", "Sira", _SIRA_REF, False,
    fr=L("En quelle année de l'hégire eut lieu la conquête pacifique de La Mecque ?",
         ...
         "Sîra — fait historique établi"),
    en=L("In which year of the Hijra did the peaceful conquest of Makkah take place?",
...
add("sira_030", "sira", "medium", "quran", "Quran", "2:142-144", False,
    fr=L("Avant que la qibla ne soit fixée vers la Ka'ba, vers quelle ville les musulmans priaient-ils ?",
         ...
         "Les musulmans priaient d'abord vers Bayt al-Maqdis ; puis Allah ordonna de se tourner vers la Mosquée sacrée.",
         "Coran — Sourate Al-Baqara, 2:142-144"),
    en=L("Before the qibla was fixed toward the Ka'bah, toward which city did Muslims pray?",
         ...
         "Muslims first prayed toward Bayt al-Maqdis; then Allah commanded turning toward the Sacred Mosque.",
         "Quran — Surah Al-Baqarah, 2:142-144"),
    ar=L("قبل تحويل القبلة إلى الكعبة، نحو أي مدينة كان المسلمون يصلّون؟",
         ["بيت المقدس", "المدينة", "الطائف", "دمشق"], 0,
         "صلى المسلمون أولًا نحو بيت المقدس؛ ثم أمر الله بالتوجه إلى المسجد الحرام.",
         "القرآن — سورة البقرة، 2:142-144"))
...
add("faith_009", "faith", "easy", "quran", "Quran", "5:6", False,
    fr=L("Comment s'appelle la purification par l'eau que le musulman fait avant la prière ?",
    ...
    en=L("What is the water purification a Muslim performs before prayer called?",
    ...
    ar=L("ما اسم الطهارة بالماء التي يقوم بها المسلم قبل الصلاة؟",
...
add("virtues_007", "virtues", "medium", "quran", "Quran", "49:12", False,
    fr=L("À quoi le Coran compare-t-il la médisance (parler d'un absent en mal) ?",
         ...
         "« L'un de vous aimerait-il manger la chair de son frère mort ? Vous en auririez horreur ! » — la médisance est aussi laide.",
