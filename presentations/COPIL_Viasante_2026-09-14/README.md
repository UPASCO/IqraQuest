...
4. Intercalaire CDM · 5. SLA Gold · 6. Base de données · 7. Audience unique (Ucount) · 8. Sécurisation et patch du 10/09 · 9. Roadmap CDM
10. Intercalaire Engage · 11. Selligent by Zeta · 12. Performance email · 13. SMS et RCS · 14. SSO Engage · 15. Pixel d'ouverture et CNIL · 16. Roadmap Engage
17. Vos arbitrages (cinq questions au client) · 18. Plan d'actions · 19. Contacts

## À confirmer avant la séance

- **SLA** : la période de référence. L'extract xlsx dit 01/07/2026 → 30/06/2027 (5,0 h / 50 h, 10 %) ;
  le dashboard BI affiche 24/02/2026 → 23/02/2027 (7,9 h / 50 h, 16 %). Le deck utilise l'extract xlsx.
  Faire qualifier les 4 tickets « None » (4,35 h, dont le 550647).
...
- **Prix** : la pricelist 6 900 €/an par tranche de 100 GB n'est pas vérifiée ; la slide dit « sur devis ».
...
- CNIL, recommandation pixels de suivi (délibération 2026-042 du 12/03/2026, publiée le 14/04/2026).
